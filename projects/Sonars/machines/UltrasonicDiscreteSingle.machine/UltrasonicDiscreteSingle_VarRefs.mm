...
#machine	&signal SCHEDULE_LENGTH: unsigned(11 downto 0) = _m->signal SCHEDULE_LENGTH: unsigned(11 downto 0);	///<
#machine	&signal SPEED_OF_SOUND: unsigned(11 downto 0) = _m->signal SPEED_OF_SOUND: unsigned(11 downto 0);	///<
#machine	&signal SONAR_OFFSET: unsigned(7 downto 0) = _m->signal SONAR_OFFSET: unsigned(7 downto 0);	///<
#machine	&signal MAX_DISTANCE: unsigned(23 downto 0) = _m->signal MAX_DISTANCE: unsigned(23 downto 0);	///<
#machine	&signal MAX_TIME: unsigned(27 downto 0) = _m->signal MAX_TIME: unsigned(27 downto 0);	///<
#machine	&signal numloops: unsigned(23 downto 0) = _m->signal numloops: unsigned(23 downto 0);	///<
#machine	&signal CLOCK_PERIOD: unsigned(7 downto 0) = _m->signal CLOCK_PERIOD: unsigned(7 downto 0);	///<
