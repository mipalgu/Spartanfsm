...
#machine	&constant RINGLETS_PER_MS: unsigned(19 downto 0) := x"F4240" / SCHEDULE_LENGTH = _m->constant RINGLETS_PER_MS: unsigned(19 downto 0) := x"F4240" / SCHEDULE_LENGTH;	///<
#machine	&signal i: unsigned(31 downto 0) = _m->signal i: unsigned(31 downto 0);	///<
#machine	&constant RINGLETS_PER_S: unsigned(31 downto 0) :=  x"3E8" * RINGLETS_PER_MS = _m->constant RINGLETS_PER_S: unsigned(31 downto 0) :=  x"3E8" * RINGLETS_PER_MS;	///<
